...
urlpatterns = [
    ...
    url(r'^publicmodels/$', 'plantillas.views.publicmodels',
        name='publicmodels'),
    url(r'^publicmodels/tag/(?P<tag>\w+)/$', 'plantillas.views.publicmodels',
        name='publicmodels'),
    ...
    url(r'^ratings/', include('star_ratings.urls', namespace='ratings',
                              app_name='ratings')),
    url(r'^update_profile/$', 'plantillas.views.update_profile',
        name='update_profile'),
    url(r'^view_profile/$', 'plantillas.views.view_profile',
        name='view_profile'),
    url(r'^view_profile/(?P<id>\d+)/$', 'plantillas.views.view_profile',
        name='view_profile'),
    url(r'^view_profile/(?P<id>\d+)/tag/(?P<tag>\w+)/$',
        'plantillas.views.view_profile', name='view_profile_tags'),
